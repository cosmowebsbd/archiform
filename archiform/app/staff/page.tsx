      ...
      <div className="p-6">
        ...
        {!loading && staff.length === 0 && (
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <h3 className="text-xl font-semibold text-navy-900 mb-2">Build your team</h3>
            <p className="text-muted-foreground text-sm max-w-sm mb-8">
              Add staff members to assign them to projects, track time, and monitor utilization.
            </p>
            <Button onClick={() => setShowModal(true)} leftIcon={<Plus className="w-4 h-4" />}>
        ...
        {!loading && staff.length > 0 && (
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {staff.map((member) => (
              <div key={member.id} className="bg-white rounded-xl border border-border p-5
